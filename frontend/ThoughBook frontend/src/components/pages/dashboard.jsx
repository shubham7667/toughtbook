          ...
          <main className="min-w-0 flex-1">
            ...
            <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-indigo-100 text-sm font-bold text-indigo-700"><img src={user?.USER_PROFILE_PIC} alt={userInitial} className='rounded-full'/></div>
                <div>
              ...
              <textarea value={thought} onChange={(event) => setThought(event.target.value)} placeholder="Start writing something meaningful..." className="min-h-28 w-full resize-none rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm leading-6 text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-indigo-400 focus:bg-white focus:ring-4 focus:ring-indigo-50" />
